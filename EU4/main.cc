	...
	if (choice == 1) {
		...
		while (true) {
			...
			if (choice == 1) { //Add Manpower
				...
				//YOU: Write code here to insert at the end of pti a province that will cost soldiers to invade and has a name of s - DONE
				...
				cin >> soldiers;
				if (!cin || soldiers < 0) die();
				//YOU: Write code here to insert at the beginning of pti a province that will cost soldiers to invade and has a name of s - DONE
				...
				//int amount = 0;
				cout << pti.delete_amount(soldiers,soldiers) << endl; //Replaced the 2nd argument of the function with 'soldiers'. Was 'amount'
			}
			else if (choice == 6) {
				...
				cin >> diplomacy;
				if (!cin || diplomacy < 0) die();
				//YOU: Write code here to insert at the end of pta a province that will cost diplomancy to invade and has a name of s - DONE
				...
				cin >> diplomacy;
				if (!cin || diplomacy < 0) die();
				//YOU: Write code here to insert at the beginning of pta a province that will cost diplomancy to invade and has a name of s - DONE
				...
				while (true) {
					...
					if (points <= 0) break; 
					s = pta.delete_amount(points,points);
					...
					//if (!deleted) cout << "Nothing deleted";

					//if (points == change) break;
					//points = change;
